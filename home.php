  ...
  <nav class="navbar navbar-inverse navbar-fixed-top"><!--Here we make a navbar-->
      <div class="container-fluid">
        <div class="navbar-header"><!--Now we want the navbar to be like buttom when we let the width of our page small  -->
            ...
            <a class="navbar-brand" href="#"><img src="http://clipart.info/images/ccovers/1496175189emoji-android-open-book.png" class="brand" width="60" height="35"></a>
        </div>
...
<div class="btn btn-danger">Logout</div></a>
           ...
           <?php
              ...
              echo "<div class='container' style='margin-top:75px;'><h1>Media CD Info</h1><table class='table table-striped'><thead><tr><th>ISBN code</th><th>title</th><th>media_type</th><th>image</th><th>short_description</th><th>publish date</th><th>status</th></tr></thead><tbody>";
            foreach($rows as $row){
              echo "<tr><td>";
                echo $row['ISBN_code'];
                echo "</td><td>";
              ...
              $rows=$result->fetch_all(MYSQLI_ASSOC);
              echo "<div class='container'><h1>Media DVD Info</h1><table class='table table-striped'><thead><tr><th>ISBN code</th><th>title</th><th>media_type</th><th>image</th><th>short_description</th><th>publish date</th><th>status</th></tr></thead><tbody>";
            foreach($rows as $row){
              echo "<tr><td>";
                echo $row['ISBN_code'];
                echo "</td><td>";
              ...
              $rows=$result->fetch_all(MYSQLI_ASSOC);
              echo "<div class='container'><h1>Media Books Info</h1><table class='table table-striped'><thead><tr><th>ISBN code</th><th>title</th><th>media_type</th><th>image</th><th>short_description</th><th>publish date</th><th>status</th></tr></thead><tbody>";
            foreach($rows as $row){
              echo "<tr><td>";
                echo $row['ISBN_code'];
                echo "</td><td>";
